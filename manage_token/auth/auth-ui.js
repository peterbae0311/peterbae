window.injectAuthUI = function injectAuthUI() {
  const container = document.createElement('div');
  container.id = 'auth-container';
  container.style.display = 'none'; /* 세션 확인 전까지 숨김 */
  container.innerHTML = `
    <div class="auth-card">
        ...
        <form id="form-login" novalidate>
          <div class="field">
            ...
            <div class="input-wrap">
              <input type="email" id="login-email" name="login-email-field" maxlength="100" autocomplete="email" />
          ...
          <div class="field">
            ...
            <div class="input-wrap">
              <input type="password" id="login-password" name="login-password-field" maxlength="100" autocomplete="current-password" />
