...
/**
 * Instructor_Expertise가 OpenRouter/Groq를 직접 호출하던 것을 대행하는 프록시.
 * course_planning의 /api/course_planning/llm과 동일한 패턴 — API 키는 브라우저로 절대
 * 내려주지 않고, hub의 Key 관리(manage_token, tokens.key_values)에서 서버 측에서만 조회한다.
 */
const PROVIDERS = {
  openrouter: {
    ...
    extraHeaders: {
      'HTTP-Referer': 'https://peterbae.duckdns.org/Instructor_Expertise',
      'X-Title': 'Personal Expertise Manager',
    },
  },
  groq: {
